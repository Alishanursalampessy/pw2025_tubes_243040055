...
<?php $data_menu = select("SELECT * FROM data_menu2"); ?>
        ...
        <table class="table table-hover table-striped align-middle" id="table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">Status_ketersedian</th>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $menu['harga']; ?></td>
                            <td><?= $menu['kategori']; ?></td>
                            <td><?= $menu['status_ketersediaan']; ?></td>
                            <a href="../php/hapus/HapusDataMenu.php?id=<?= urlencode($menu['id']); ?>" class="action-btn edit-btn" title="Ubah Data">
                                <span class="icon">&#9998;</span>Ubah
                            </a>
                            <a href="../php/hapus/HapusDataMenu.php?id=<?= urlencode($menu['id']); ?>" class="action-btn delete-btn"
                                onclick="return confirm('Yakin ingin menghapus data ini?')" title="Hapus Data">
                                <span class="icon">&#128465;</span>Hapus
                            </a>
                            <a href="DetailMenu.php?id=<?= urlencode($menu['id']); ?>" class="action-btn detail-btn" title="Lihat Detail">
