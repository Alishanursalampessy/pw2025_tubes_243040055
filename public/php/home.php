    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item me-3">
                    <a class="nav-link" href="#menu-favorit"><i class="bi bi-star"></i> Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="bi bi-cup-hot"></i> Pesan</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-md-8 text-center position-relative">
                ...
                <div class="banner-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="#menu-favorit" class="btn btn-warning btn-lg mt-3 shadow animate__animated animate__pulse animate__infinite">Lihat Menu <i class="bi bi-cup-hot"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100 shadow menu-card animate__animated animate__fadeInUp" style="font-size:1rem;">
                    ...
                    <div class="card-footer bg-white border-0 py-2 px-3 d-flex justify-content-between align-items-center">
                        <span class="fw-bold text-primary" style="font-size:1.08rem;">Rp25.000</span>
                        <a href="#" class="btn btn-outline-primary btn-sm px-3">Pesan</a>
                    </div>
                </div>
            </div>
            <!-- Menu Card 2 -->
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100 shadow menu-card animate__animated animate__fadeInUp" style="font-size:1rem;">
                    ...
                    <div class="card-footer bg-white border-0 py-2 px-3 d-flex justify-content-between align-items-center">
                        <span class="fw-bold text-primary" style="font-size:1.08rem;">Rp20.000</span>
                        <a href="#" class="btn btn-outline-primary btn-sm px-3">Pesan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100 shadow menu-card animate__animated animate__fadeInUp" style="font-size:1rem;">
                    ...
                    <div class="card-footer bg-white border-0 py-2 px-3 d-flex justify-content-between align-items-center">
                        <span class="fw-bold text-primary" style="font-size:1.08rem;">Rp8.000</span>
                        <a href="#" class="btn btn-outline-primary btn-sm px-3">Pesan</a>
                    </div>
                </div>
            </div>
